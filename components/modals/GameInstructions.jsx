...
export const GameInstructions = () => {
    ...
    return (
        <div className={"pr-4 right-0 justify-end flex fixed top-20 z-[1000] font-caveat w-full"}>
            <div className={"GameInstructions w-1/3 p-2 rounded-lg backdrop-blur bg-[#ffffffC4] animate-dropDown"}>
                <p className={"mt-1 text-black font-normal text-xl text-center"}>
